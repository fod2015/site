(function ($) {
	...
	$.jBar = function (options) {
		...
		// jBar Styles
		var styles = '<style>' + '.jbar{background:' + backgroundColor + ';top:0;left:0;right:0;height:46px;z-index:999998;color:#FFF;border-bottom:0px;' 
					 ...
					 + '.text{display:block;padding:0;margin:0;font-family:Microsoft YaHei;letter-spacing:0.15em;font-weight:900;text-align:center;}' + '.text a{font-weight:500;text-decoration:none;color:' 
